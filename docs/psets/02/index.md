...
**Hoofdstuk 1 — The Way of the Program**

- 1.4 — *Arithmetic operators*
- 1.5 — *Values and types*

**Hoofdstuk 2 — Variables, expressions and statements**
...
Lever Problem Set 2 uiterlijk **{{ schedule.weeks[2].pset.deadline }}** in.
...
{% for moment in schedule.weeks[2].vakflex %}
**{{ moment.date }}**  
{{ moment.topic }}
