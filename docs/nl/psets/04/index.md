...
2. Maak één van de volgende versies:
    - [Keep the Change](keep-the-change-less.md) — **Minder vertrouwd**
      *Kies deze versie als je je minder vertrouwd voelt met de stof.*
    - [Keep the Change](keep-the-change-more.md) — **Meer vertrouwd**
      *Kies deze versie als je je meer vertrouwd voelt met de stof.*

3. Maak één van de volgende versies:
    - [Bad Nut Check](bad-nut-check-less.md) — **Minder vertrouwd**
      *Kies deze versie als je je minder vertrouwd voelt met de stof.*
    - [Bad Nut Check](bad-nut-check-more.md) — **Meer vertrouwd**
      *Kies deze versie als je je meer vertrouwd voelt met de stof.*

4. Werk **Portfolio 4** bij.
...
Lees in hoofdstuk 8 — *Strings*:

- 8.8 — *String methods*
- 8.9 — *The in operator*
- 8.10 — *String comparison*

Wil je extra oefenen? Maak dan:
...
{{ resource_group("w3schools.week4") }}


## Wanneer moet het af zijn?

Lever Problem Set 4 uiterlijk **{{ schedule.weeks[4].pset.deadline }}** in.
...
{% for moment in schedule.weeks[4].vakflex %}
**{{ moment.date }}**  
{{ moment.topic }}
