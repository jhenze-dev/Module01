...
2. Maak één van de volgende versies:
    - [Monk's Magazine Check](monks-magazine-check-less.md) — **Minder vertrouwd**
      *Kies deze versie als je je minder vertrouwd voelt met de stof.*
    - [Monk's Magazine Check](monks-magazine-check-more.md) — **Meer vertrouwd**
      *Kies deze versie als je je meer vertrouwd voelt met de stof.*

3. Maak één van de volgende versies:
    - [Monk's Perfect Order](monks-perfect-order-less.md) — **Minder vertrouwd**
      *Kies deze versie als je je minder vertrouwd voelt met de stof.*
    - [Monk's Perfect Order](monks-perfect-order-more.md) — **Meer vertrouwd**
      *Kies deze versie als je je meer vertrouwd voelt met de stof.*

4. Werk **Portfolio 6** bij.
...
{{ resource_group("w3schools.week6") }}


## Wanneer moet het af zijn?

Lever Problem Set 6 uiterlijk **{{ schedule.weeks[6].pset.deadline }}** in.
...
{% for moment in schedule.weeks[6].vakflex %}
**{{ moment.date }}**  
{{ moment.topic }}
