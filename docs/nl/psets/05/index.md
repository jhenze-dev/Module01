...
2. Maak één van de volgende versies:
    - [House Administration](house-administration-less.md) — **Minder vertrouwd**
      *Kies deze versie als je je minder vertrouwd voelt met de stof.*
    - [House Administration](house-administration-more.md) — **Meer vertrouwd**
      *Kies deze versie als je je meer vertrouwd voelt met de stof.*

3. Maak één van de volgende versies:
    - [Sorting Hat System](sorting-hat-system-less.md) — **Minder vertrouwd**
      *Kies deze versie als je je minder vertrouwd voelt met de stof.*
    - [Sorting Hat System](sorting-hat-system-more.md) — **Meer vertrouwd**
      *Kies deze versie als je je meer vertrouwd voelt met de stof.*

4. Werk **Portfolio 5** bij.
...
{{ resource_group("w3schools.week5") }}


## Wanneer moet het af zijn?

Lever Problem Set 5 uiterlijk **{{ schedule.weeks[5].pset.deadline }}** in.
...
{% for moment in schedule.weeks[5].vakflex %}
**{{ moment.date }}**  
{{ moment.topic }}
